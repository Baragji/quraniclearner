...
@ApiTags('Indstillinger')
@Controller('settings')
export class SettingsController {
  constructor(private readonly settingsService: SettingsService) {}

  @Post()
  @ApiOperation({ summary: 'Opret brugerindstillinger' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Hent brugerindstillinger efter ID' })
  ...
  @Get('user/:userId')
  @ApiOperation({ summary: 'Hent brugerindstillinger efter bruger-ID' })
